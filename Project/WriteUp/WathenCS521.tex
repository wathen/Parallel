...
For this project we will mainly focus on parallel finite element method within the \fenics  software framework \cite{wells2012automated}. However, we will also look at a simple parallel Laplacian solve as well.
...
At this point there is no known parallel implementation of this discretisation for the MHD model with these specific elements used in \cite{schotzau2004mixed}.
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|ccccc|}
        \hline
