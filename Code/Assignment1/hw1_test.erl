...
prefix_test() ->
    [ ?assertMatch(true, hw1:prefix([], [1,2,3])),
      ...
      ?assertError(function_clause, hw1:prefix(banana, [1,2,3])),
...
search_test() ->
    [ ?assertMatch([2,8], hw1:search([2,3], [1,2,3,4,3,2,1,2,3,4])),
      ...
      ?assertMatch([1,2,3,4,5,6,7], hw1:search([], "banana")),
      ?assertMatch([], hw1:search("banananana", "banana")),
      ?assertError(function_clause, hw1:search(10, []))
    ].
...
subtract_test() ->
    [ ?assertMatch([], hw1:subtract([], [1,2,3])),
      ...
      ?assertMatch([2,1], hw1:subtract([3,2,1], [3])),
      ?assertError(function_clause, hw1:subtract(banana, [1,2,3]))
      ].
